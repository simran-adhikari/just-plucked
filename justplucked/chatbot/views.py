...
def create_chatbot():
    return ChatBot(
        'FarmersMarketplaceBot',
        storage_adapter='chatterbot.storage.SQLStorageAdapter',
        database_uri=None,
        logic_adapters=[
            {
                'import_path': 'chatterbot.logic.BestMatch',
                'default_response': "I'm not sure how to answer that. Can you ask something about our farmers market products?",
...
def chat_view(request):
    return render(request, 'website/chatbot/chat.html')

def get_response(request):
    chatbot = create_chatbot()
    user_input = request.GET.get('input', '')
    
    # Train with your custom data (in-memory)
    from chatterbot.trainers import ListTrainer
    trainer = ListTrainer(chatbot)
    
    custom_data = [
    "hi", "Hello! Welcome to our Farmers Marketplace. Ask me about fresh farm products and services!",
    "hello", "Hello there! How can I assist you with our farm products?",
    "hey", "Hi! Ask me about our fresh farm products and services.",
    "good morning", "Good morning! How can I help you today?",
    "good evening", "Good evening! Looking for something fresh?",
    ...
    # Train separately on English greetings and conversations
